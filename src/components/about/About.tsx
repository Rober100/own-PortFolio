      ...
      <div className="about__container container grid">
        ...
        <div className="about__data">
          ...
          <p className="about__description">
            Me enfoco en construir productos web escalables y de alta calidad,
            aplicando las mejores prácticas de desarrollo ágil. Disfruto
            aprender constantemente nuevas tecnologías y frameworks para
